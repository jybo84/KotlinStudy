...
fun main() {
    val wednesday = Forecast1(dayTemp = 15, nightTemp = 8, fallout = "Дождь", dayOfWeek = "среда")
    wednesday.printInfo()
}

class Forecast1(val dayTemp: Int, val nightTemp: Int, var fallout: String, var dayOfWeek: String) {
    fun printInfo(){

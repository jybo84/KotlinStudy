...
fun main(){
    var tableTodayBuzy = 13
    var tableTomorrowBuzy = 9

    var bookingToday = tableTodayBuzy < TOTAL_TABLE
    var booringTomorrow = tableTomorrowBuzy < TOTAL_TABLE
    println("Доступность столиков на сегодня: $bookingToday, \nДоступность столиков на сегодня: $booringTomorrow")
}